...
using namespace  ::algotrade::api;

class AlgoTradeHandler : virtual public AlgoTradeIf {
 public:
  AlgoTradeHandler() {
...
int main(int argc, char **argv) {
  int port = 9090;
  shared_ptr<AlgoTradeHandler> handler(new AlgoTradeHandler());
  shared_ptr<TProcessor> processor(new AlgoTradeProcessor(handler));
