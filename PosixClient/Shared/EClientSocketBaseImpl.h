...
// verifyRequest is not called anywhere
...
// verifyMessage is not called anywhere
...
// queryDisplayGroups is not called anywhere
...
bool EClientSocketBase::checkMessages()
{
	...
	//std::cout<<"0==Inside EClientSocketBase::checkMessages()"<<m_pEWrapper->m_state<<std::endl;
	...
	try {
		while( (m_connected ? processMsg( ptr, endPtr)
			...
			//std::cout<<"1==Inside EClientSocketBase::checkMessages()"<<m_pEWrapper->m_state<<std::endl;
	...
	//std::cout<<"2==Inside EClientSocketBase::checkMessages()"<<m_pEWrapper->m_state<<std::endl;
